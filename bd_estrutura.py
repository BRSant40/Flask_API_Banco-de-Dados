...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Vinicius25304512$@db.uknpyxtedfcbkqjqdeqn.supabase.co:5432/postgres'
db = SQLAlchemy(app)
db: SQLAlchemy
...
def inicializar_banco():
    ...
    with app.app_context():
        ...
        autor = Autor(nome='bruno', email='bruno@email.com',senha='123456', admin=True)
